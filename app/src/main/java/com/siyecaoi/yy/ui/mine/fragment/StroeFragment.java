...
import com.siyecaoi.yy.dialog.MyGiftShowDialog;
...
import com.siyecaoi.yy.ui.mine.SendOtherActivity;
import com.siyecaoi.yy.ui.mine.adapter.StoreListAdapter;
...
public class StroeFragment extends MyBaseFragment {
    ...
    private void setData(List<StoreListBean.DataEntity> data, StoreListAdapter adapter) {
...
//        mRecyclerView.setPadding(10, 0, 0, 0);
        storeListAdapter = new StoreListAdapter(R.layout.item_store);
