...
import com.siyecaoi.yy.ui.mine.adapter.MyFansListAdapter;
...
public class MyFriendsActivity extends MyBaseActivity {
    ...
    FriendListAdapter fansListAdapter;
...
//                    mscrollViewFriend.fullScroll(ScrollView.FOCUS_UP);
    ...
    private void setRecycler() {
        fansListAdapter = new FriendListAdapter(R.layout.item_attention);
    ...
    private void showMyDialog(MyattentionBean.DataEntity dataEntity, int position) {
        ...
        myDialog = new MyDialog(MyFriendsActivity.this);
        myDialog.show();
