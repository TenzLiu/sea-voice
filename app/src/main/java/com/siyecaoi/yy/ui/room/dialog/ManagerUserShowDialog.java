 ...
 * 管理员点击麦位
 */
public class ManagerUserShowDialog extends Dialog {
    ...
    public ManagerUserShowDialog(Context context, ArrayList<String> bottomList, VoiceMicBean.DataBean dataBean, int userId, boolean isUserOpration) {
