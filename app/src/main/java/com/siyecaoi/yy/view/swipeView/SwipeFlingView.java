package com.siyecaoi.yy.view.swipeView;
...
public class SwipeFlingView extends AdapterView {
    ...
    private int MAX_VISIBLE = 3;//最多可显示的卡片数
    ...
    private float mCardVerticalOffset = 15;//定义卡片每级偏移值
    ...
    public void setmCurPositon(int mCurPositon) {
        this.mCurPositon = mCurPositon;
    }
...
//        mCardVerticalOffset = 6f * density;
    ...
    private void resetChildView(View childView) {
        ...
        /**当返回的时候重新修正LAST_OBJECT_IN_STACK的值*/
        LAST_OBJECT_IN_STACK = getChildCount() - 1;
