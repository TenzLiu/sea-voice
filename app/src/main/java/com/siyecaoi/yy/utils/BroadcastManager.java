...
public class BroadcastManager {
    ...
    public void sendBroadcast(String action, Object obj) {
        try {
            ...
            intent.putExtra(Const.ShowIntent.DATA, new Gson().toJson(obj));
    ...
    public void sendBroadcast(String action, String s) {
        Intent intent = new Intent();
        intent.setAction(action);
        intent.putExtra(Const.ShowIntent.DATA, s);
        mContext.sendBroadcast(intent);
    }
     ...
     * @param enabled
     */
    public void sendBroadcast(String action, boolean enabled) {
        Intent intent = new Intent();
        intent.setAction(action);
        intent.putExtra(Const.ShowIntent.DATA, enabled);
        mContext.sendBroadcast(intent);
    }
